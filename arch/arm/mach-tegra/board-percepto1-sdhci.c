/*
 * arch/arm/mach-tegra/board-percepto1-sdhci.c
 *
...
static struct tegra_sdhci_platform_data tegra_sdhci_platform_data0 = {
	...
	.calib_1v8_offsets = 0x7676,
        .max_clk_limit = 81600000, /* lower initial clock for Marvell SDIO */
	.disable_clock_gate = 1, /* disable clock gating for Marvell SDIO */
};

/* SD card */
static struct tegra_sdhci_platform_data tegra_sdhci_platform_data2 = {
  .cd_gpio = ARDBEG_SD_CD, /* We have a card-detect pin on the percepto1.3 */
	.wp_gpio = -1,
	.power_gpio = -1,
	.tap_delay = 0,
	.trim_delay = 0x3,
...
int __init percepto1_sdhci_init(void)
{
	int nominal_core_mv;
